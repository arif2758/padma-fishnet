    ...
    <div>
      {session && (
        <Link href={"#"} onClick={() => signOut()}>
          <div className="flex items-center space-x-2 px-2 py-1 rounded text-red-500 hover:text-red-700 hover:bg-blue-100 focus-visible:text-blue-600 dark:focus-visible:text-blue-400 
